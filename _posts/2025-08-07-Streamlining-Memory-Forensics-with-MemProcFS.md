...
- [Forensic Output](#forensic-output)
  - Recovered Files (M:\forensic\files)
  - Malware Indicators (M:\forensic\findevil)
  - NTFS Artifacts (M:\forensic\ntfs)
  - Timeline Analysis (M:\forensic\timeline)
  - Web Activity (M:\forensic\web)
- [Process Information](#process-information)
  - Process Listings (M:\sys\proc)
  - Process-specific data (M:\name or M:\pid)
- [Network Connections](#network-connections)
  - Network Connections (M:\sys\net)
  - DNS Entries (M:\sys\net\dns)
- [Event Logs](#event-logs)
  - Evtx files (M:\misc\eventlog)
- [Registry](#registry)
  - Registry Hive Files (M:\registry\hive_files)
  - Registry By-Hive (M:\registry\by-hive)
  - Registry HKLM (M:\registry\HKLM)
- [Persistence Checks](#persistence-checks)
  - Services (M:\sys\services)
  - Scheduled Tasks (M:\sys\tasks)
